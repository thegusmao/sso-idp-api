...
public class LevelService {
	...
	public String getLevel(String token, String cpf) {
		...
		try {
			...
			if (originalToken != null) {
				...
				HttpGet get = new HttpGet(govBrUrl + "/confiabilidades/v3/contas/" + cpf + "/niveis?response-type=ids");
				...
				logger.debug("Level for " + cpf + " -> " + jsonResp);
				return jsonResp;
			}
